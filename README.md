...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-tabler-1737106627) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-tabler-1737106627.git
$ cd django-tabler-1737106627
```
